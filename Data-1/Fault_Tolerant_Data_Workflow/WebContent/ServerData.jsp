...
try{
	...
	ResultSet rs = st.executeQuery("select * from serverdata");

%>


<div class="container">
    <h3>Server Data Details</h3>
    <hr style="background:blue; ">
    
    <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title">Server Data History Details</h3>
                ...
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="File Size" disabled></th>
                         <th><input type="text" class="form-control" placeholder="Domain Data" disabled></th>
