    ...
    <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title">Search Login User Activity History Details</h3>
            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="User E-mail" disabled></th>
                ...
                %>
                    <tr>
                        <td><%=i %></td>
                        <td><%=rs.getString("searchitem") %></td>
                        <td><%=rs.getString("searchtime") %></td>
                        <td><%=rs.getString("searchuser") %></td>
