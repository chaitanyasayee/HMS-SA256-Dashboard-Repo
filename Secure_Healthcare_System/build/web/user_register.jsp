				...
				<div class="row">
					<div class="col-xs-12">
						<div class="top">
							<div class="row">
								<div class="col-md-6">
									<div id="colorlib-logo"><a href="index.html">Secure <span>Health care System</span> </a></div>
								</div>
								<div class="col-md-3">
									<div class="num">
				...
				<div class="col-md-12 animate-box">
					<div class="row">
							...
							<form action="process.jsp">
								<div class="row form-group">
									<div class="col-md-6">
										...
										<input type="text" id="name" class="form-control mb" name="name" placeholder="Your name">
									</div>
									<div class="col-md-6">
								...
								<div class="row form-group">
									<div class="col-md-12">
										...
										<textarea name="text" id="message" cols="30" rows="10" class="form-control" name="address" placeholder="Enter your address"></textarea>
									</div>
								</div>
						...
						<!--	<div id="map" class="colorlib-map"></div> -->
                                                        <iframe id="map" class="colorlib-map" src="https://maps.google.com/maps?q=strydo%20technologies%20vellore&t=k&z=13&ie=UTF8&iwloc=&output=embed" allowfullscreen="" loading="lazy"></iframe>
